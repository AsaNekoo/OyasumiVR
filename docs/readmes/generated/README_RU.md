...
Дополнительно, контроллеры и/или трекеры могут выключаться на определенном уровне заряда, или когда вы ставите их на зарядку. Идеально для быстрой замены контроллеров! 
  ...
  <tr>
    <td>
<b>Политика электропитания System</b>
<br>
Экономьте электроэнергию автоматически изменяя политику электропитания System когда вы засыпаете, и просыпаетесь! Устанавливайте более сберегательную политику (например "Экономия энергии") когда вы ложитесь спать, а потом меняйте на политику большей производительности когда вы просыпаетесь. 
    </td>
...
<ул>
  ...
  <li>Завершение работы System</li>
</ul>
<br>
