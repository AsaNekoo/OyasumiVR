...
function rpc(id:number,payload: any){
    ws.send(id.toString()+":"+JSON.stringify(payload));
}
window.CefSharp=CefSharp;
window.OyasumiOverlayIPCOut=OyasumiOverlayIPCOut;
window.OyasumiOverlayIPCOut_Dashboard=OyasumiOverlayIPCOut_Dashboard;
